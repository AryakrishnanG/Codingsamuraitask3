...
class ExpenseTracker():
    ...
    def create_widgets(self):
        ...
        self.main_label = tk.Label(self.root, text='Expense Tracker', font=('Cascadia Mono', 40, 'bold'),
                           bg='Yellow', fg='Purple', bd=5, relief='solid')
        self.main_label.place(x=250, y=50, height=70, width=500)
        ...
        self.track_button.place(x=100, y=140, height=60, width=210)
        ...
        self.summary_button.place(x=400, y=140, height=60, width=210)
        ...
        self.delete_button.place(x=700, y=140, height=60, width=250)
        ...
        self.date_label = tk.Label(self.root, text='Enter the date of the expense (YYYY-MM-DD): ',
                                   font=('HP Simplified Hans Light', 17), bg=Mossgreen )
        ...
        self.price_label = tk.Label(self.root, text='Enter the price: ',
                                    font=('HP Simplified Hans Light', 15), bg=Mossgreen )
